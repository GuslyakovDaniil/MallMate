...
var shops = [
    { id: 'shop1', name: 'DNS', image: '/img/dns.png', description: 'Компания DNS является одним из лидеров цифрового ритейла России. Для Вас космический ассортимент: компьютеры, ноутбуки, смартфоны, телевизоры, аксессуары и многое другое. Предназначение DNS – быть лучшим проводником товара от производителя к покупателю!' },
